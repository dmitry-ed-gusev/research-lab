...
/**
 * Various array sort algorithms.
 * @author Gusev Dmitrii (vinnypuhh)
...
public final class ArraysSort {
    ...
    public static int[] mergeSort(int[] array) {
        ...
        if (array == null) { // null-check (safety), return empty array in this case
            return new int[0];
        }
        ...
        if (array.length > 2) { // split and recursive call
            ...
            int[] sortedLeft  = ArraysSort.mergeSort(left);  // recursive call
            int[] sortedRight = ArraysSort.mergeSort(right); // recursive call
    ...
    public static int[] selectionSort(int[] array) {
        ...
        if (array == null) { // null-check (safety), return empty array in such case
            return new int[0];
        }
    ...
    public static int[] bubbleSort(int[] array) {
        ...
        if (array == null) { // null-check (safety), return empty array
            return new int[0];
        }
    ...
    public static void main(String[] args) {
        ...
        System.out.println("merge sort     -> " +
                Arrays.toString(ArraysSort.mergeSort(Arrays.copyOf(array, array.length))));

        System.out.println("selection sort -> " +
                Arrays.toString(ArraysSort.selectionSort(Arrays.copyOf(array, array.length))));

        System.out.println("bubble sort    -> " +
                Arrays.toString(ArraysSort.bubbleSort(Arrays.copyOf(array, array.length))));

        System.out.println("coctail sort   -> " +
                        Arrays.toString(ArraysSort.coctailSort(Arrays.copyOf(array, array.length))));
    }
