...
public final class ModelsBuilder {
        ...
        if ((serverKeysList != null) && (!serverKeysList.isEmpty())) {
            if ((clientKeysList != null) && (!clientKeysList.isEmpty())) {
                ...
                for (Integer key : serverKeysList) {
                    if ((key != null) && (!clientKeysList.contains(key))) {
                        list.add(key);
                    }
                }
            ...
            for (String tableName : serverModel.getTablesList()) {
                ...
                if (clientModel.containsTable(tableName)) {
                    ...
                    if ((keys != null) && (!keys.isEmpty())) {
                        ...
                        if (model == null) {
                            model = new SimpleDBIntegrityModel(serverModel.getDbName());
                        }
    ...
    public static void main(String[] args) throws org.apache.commons.configuration2.ex.ConfigurationException, ClassNotFoundException, SQLException, InstantiationException, IllegalAccessException {
        ...
        try {
            ...
            Connection conn = DBUtilities.getDBConn(config);
            Connection msSqlConn = DBUtilities.getDBConn(msSqlConfig);
            logger.info("started");
