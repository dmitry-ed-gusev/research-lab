...
public class EmailsDAO extends DBConfigCommonDAO {
     ...
     * Конструктор.
     */
    public EmailsDAO() throws ConfigurationException {
     ...
     */
    public ArrayList<EmailDTO> findByDeliveryId(int id) throws IllegalAccessException, ClassNotFoundException, InstantiationException {
        ...
        if (id > 0) {
            ...
            try {
                ...
                // Ничо не нашли
                    ...
                    logger.warn("Result set is empty! Emails for delivery [" + id + "] not found!");
                }
        ...
        // Если идентификатор не подходит - ошибка
            ...
            logger.error("Delivery ID is negative!");
        }
        return emailsList;
    }
    ...
    public void change(EmailDTO email) throws IllegalAccessException, ClassNotFoundException, InstantiationException {
