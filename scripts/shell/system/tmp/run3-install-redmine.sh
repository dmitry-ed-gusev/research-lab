...
#sudo cp $SCRIPT_HOME/$SOFTWARE_HOME/apache/passenger.load $APACHE_SETTINGS/mods-available
#sudo cp $SCRIPT_HOME/$SOFTWARE_HOME/apache/passenger.conf $APACHE_SETTINGS/mods-available
