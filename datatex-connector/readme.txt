...
-------------------------------------------------------------------------------------------------------------
    ...
    --importds <ds name>             - загрузка датасета из CSV файлов из каталога [csv_import]. Структура данных в формате CSV для загрузки на сервер LuxMS
                                       указана ниже в разделе "Формат CSV датасета LuxMS BI".
...
В конфигурационном файле должны быть селдующие разделы:
    ...
    [general_env] <- окружение для общих параметров системы
        csv_export_dir: <value> <- todo: desc!!!
        csv_import_dir: <value> <- todo: desc!!!
    =======================================================
