...
public class SqlExecutor {
    ...
    public static ResultSet executeSelectQuery(Connection connection, String sql, boolean useSqlFilter)
        ...
        if (connection == null) {
            throw new DBConnectionException("Connection to DBMS is empty!");
        }
        // Если нам передан пустой запрос - ошибка!
        if (StringUtils.isBlank(sql)) {
            throw new SQLException("Empty sql-query!");
        }

        // Если запрос неверного типа - не SELECT-запрос - ошибка!
        //if (!DBUtils.isSelectQuery(sql)) {
        //    throw new SQLException("No SELECT-query for this method!");
        //}
        ...
        String realSql;
        if (useSqlFilter) {
            realSql = SqlFilter.removeDeprecated(sql);
        } else {
            realSql = sql;
        }
    ...
    public static ResultSet executeSelectQuery(Connection connection, String sql)
            throws SQLException, DBConnectionException {
        return SqlExecutor.executeSelectQuery(connection, sql, true);
    }
    ...
    public static ResultSet executeSelectQuery(Connection connection, StringBuffer sql, boolean useSqlFilter)
        ...
        if ((sql == null) || (StringUtils.isBlank(sql.toString()))) {
            ...
            return SqlExecutor.executeSelectQuery(connection, sql.toString(), useSqlFilter);
        }
    }
    ...
    public static String executeStrSelectQuery(Connection connection, String sql, boolean useSqlFilter)
        ...
        return DBUtilities.getStringResultSet(rs, 80);
    }
    ...
    public static String executeStrSelectQuery(Connection connection, String sql)
            throws DBConnectionException, SQLException {
        return SqlExecutor.executeStrSelectQuery(connection, sql, true);
    }
    ...
    public static String executeStrSelectQuery(DBConfig config, String sql, boolean useSqlFilter)
            throws SQLException, DBModuleConfigException, DBConnectionException, IllegalAccessException, InstantiationException, ClassNotFoundException {
        logger.debug("executeStrSelectQuery: executing query [" + sql + "].");
        String result = null;
        ...
        // Если же конфиг в порядке - выведем отладочной сообщение
            ...
            logger.debug("DBMS connection config is OK. Processing.");
        }
        ...
        try {
            ...
            result = DBUtilities.getStringResultSet(rs, 80);
        }
    ...
    public static String executeStrSelectQuery(DBConfig config, String sql)
            throws SQLException, DBModuleConfigException, DBConnectionException, IllegalAccessException, ClassNotFoundException, InstantiationException {
        return SqlExecutor.executeStrSelectQuery(config, sql, true);
    }
    ...
    public static int executeUpdateQuery(DBConfig config, String sql, boolean useSqlFilter)
        ...
        //if (DBUtils.isSelectQuery(sql)) {
        //    throw new SQLException("SELECT-query for this method is not allowed!");
        //}
        ...
        try {
            ...
            if (useSqlFilter) {
                result = statement.executeUpdate(SqlFilter.removeDeprecated(sql));
            } else {
    ...
    public static int executeUpdateQuery(DBConfig config, StringBuilder sql, boolean useSqlFilter)
        ...
        if ((sql == null) || (StringUtils.isBlank(sql.toString()))) {
            ...
            return SqlExecutor.executeUpdateQuery(config, sql.toString(), useSqlFilter);
        }
    }
    ...
    public static int executeUpdateQuery(Connection connection, String sql)
            throws SQLException, DBConnectionException {
        return SqlExecutor.executeUpdateQuery(connection, sql, true);
    }
    ...
    public static int executeUpdateQuery(Connection connection, StringBuffer sql, boolean useSqlFilter)
        ...
        if ((sql == null) || (StringUtils.isBlank(sql.toString()))) {
            ...
            return SqlExecutor.executeUpdateQuery(connection, sql.toString(), useSqlFilter);
        }
    }
