...
public abstract class AbstractClient {
    ...
    public CloseableHttpResponse sendHttpGet(String uri) throws IOException {
        ...
        return MyHttpUtils.sendHttpGet(this.HTTP_CLIENT, this.HTTP_CONTEXT, this.HTTP_REQUEST_CONFIG, uri);
    }
    ...
    public CloseableHttpResponse sendHttpPost(String uri, List<NameValuePair> postParams, Header[] cookies) throws IOException {
        ...
        return MyHttpUtils.sendHttpPost(this.HTTP_CLIENT, this.HTTP_CONTEXT, this.HTTP_REQUEST_CONFIG, uri, postParams, cookies);
    }
    ...
    public CloseableHttpResponse submitForm(Document document, String actionPrefix, Map<String, String> additionalFormParams, Header[] cookies) throws IOException {
        ...
        String              actionUrl      = MyHttpUtils.getFirstFormActionURL(document, actionPrefix);
        List<NameValuePair> formParamsList = MyHttpUtils.getFirstFormParams(document, additionalFormParams);
        // submit form and return http response
        //return this.sendHttpPost(actionUrl, formParamsList, cookies);
        return MyHttpUtils.sendHttpPost(this.HTTP_CLIENT, this.HTTP_CONTEXT, this.HTTP_REQUEST_CONFIG, actionUrl, formParamsList, cookies);
    }
