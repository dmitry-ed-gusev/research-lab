...
import static gusev.dmitry.utils.MyHttpUtils.HTTP_GET_COOKIES_HEADER;
    ...
    private Pair<Date, String> getAccessToken() throws IOException {
        ...
        try {
            ...
            for (int counter = 1; counter <= OK_ACCESS_ATTEMPTS_COUNT; counter++) {
                ...
                httpPageContent = MyHttpUtils.getPageContent(httpEntity, DEFAULT_ENCODING); // get html page content
