...
```
cd existing_repo
git remote add origin https://git.severstal.severstalgroup.com/ick-common/auto-ops.git
git branch -M master
...
- [ ] [Set up project integrations](https://git.severstal.severstalgroup.com/ick-common/auto-ops/-/settings/integrations)
