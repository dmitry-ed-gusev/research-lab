...
public class GSONHandleExample {
    ...
    public static void runShortcut(Util.ExampleProperties props) throws IOException {
    ...
    public static void runStrongTyped(Util.ExampleProperties props) throws IOException {
        String filename = "flipper.json";
